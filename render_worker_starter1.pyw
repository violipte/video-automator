"""Render Worker #1 (paralelo) — WORKER_ID=1, temp_w1/, log render_worker_w1.log."""
import subprocess
import sys
import os
...
subprocess.Popen(
    ...
    cwd=pasta,
    env=env,
    stdout=open(os.path.join(pasta, "logs", "render_worker_w1.log"), "a"),
